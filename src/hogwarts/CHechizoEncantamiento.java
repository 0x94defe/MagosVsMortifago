...
public final class CHechizoEncantamiento extends CHechizo {
	...
	public CHechizoEncantamiento(
		...
		super(nombre, descr, coste, distancia, faccionesPermitidas, ETipoHabilidad.ENCANTAMIENTO, valorEspecial, estrategia);
		this.tipoEncantamiento = tipoEncantamiento;
	}	
	
	@Override   
    public CHechizoEncantamiento clonar() {
        return (CHechizoEncantamiento) super.clonar();
    }
	
	@Override
	protected String getMasDetallesEspecificos() {
		return "Tipo Encatamiento:   " + tipoEncantamiento + "\n";
	}

	public ETipoEncantamiento getTipoEncantamiento() {
	    return tipoEncantamiento; 
	}
}
